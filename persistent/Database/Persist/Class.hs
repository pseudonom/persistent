...
type PersistUnique a = (PersistUniqueRead a, PersistUniqueWrite a)
type PersistQuery a = (PersistQueryRead a, PersistQueryWrite a)
type PersistStore a = (PersistStoreRead a, PersistStoreWrite a)
